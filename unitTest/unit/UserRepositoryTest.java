...
public class UserRepositoryTest {
    ...
    -> Answer:
    You can find an application-test.properties file in the resources folder. In this file the username and password are specified.
    The Line Number 24 gave it away. "@TestPropertySource("classpath:application-test.properties")"
    H2 does provide a UI.
     */
